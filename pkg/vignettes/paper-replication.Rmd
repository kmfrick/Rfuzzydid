...
The data comes from the INPRES school construction program in Indonesia, examining the effect of education on wages. We use the bundled `inpresdata.dta` file shipped in `inst/extdata`.
