...
The replication starts from `inpresdata.dta`, which is not bundled with the
package to keep the source tarball small. The file originates from David
Roodman's replication materials
...
that downloadable location. Download `inpresdata.dta` from Roodman's
