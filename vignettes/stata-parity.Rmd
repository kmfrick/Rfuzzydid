...
Unlike the core LATE estimands, the current native LQTE path does not yet
numerically match the upstream Stata command on this fixture.
...
# These diagnostics are deterministic in R because bootstrap seeding is fixed.
